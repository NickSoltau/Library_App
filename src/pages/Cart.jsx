                ...
                <div className="books__container">
                                ...
                                {cart.map((book) => {
                                    return (
                                          <div className="cart__item">
                                            ...
                                            <div className="cart__total">{(book.quantity *(book.salePrice || book.originalPrice)).toFixed(2) }
                                            </div>
                                            </div>
                                        )
                                    })                                    
                    ...
                    {cart.length >0 && (<div className="total">
                        ...
                        <div className="total__item total__price">
                            <span>Total</span>
                            <span>$ {(subtotal()*tax+ subtotal()).toFixed(2)} </span>
                        </div>
                        <button className="btn btn__checkout no__cursor" onClick={() =>alert("Do not have this connected to payment system")}>Proceed to checkout</button>
                    </div>)}
                </div>
                </div>
            </main>
